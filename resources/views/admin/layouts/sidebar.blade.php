    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="{{ asset('storage/logo1.png') }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset('storage/logo1.png') }}" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{ asset('storage/logo1.png') }}" class="header-brand-img light-logo" alt="logo">
                <img src="{{ asset('storage/logo1.png') }}" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
        </div>
